...
export function Hero({
  ...
  return (
    ...
    >
      {/* Navbar Overlay */}
      <div className="absolute top-0 left-0 right-0 z-50 pt-6 md:pt-8 px-4 md:px-8">
        <SlideTabs />
      </div>
      ...
      {/* Radial Accent */}
      <div
        className="absolute rounded-[100%] bg-white dark:bg-black
      ...
      {/* Title */}
      <h1
        className="animate-fade-in -translate-y-4 text-balance text-center mx-auto max-w-4xl
      ...
      {/* Subtitle */}
      <p
        className="animate-fade-in mb-12 -translate-y-4 text-balance text-center mx-auto max-w-2xl
